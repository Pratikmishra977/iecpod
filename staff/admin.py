...
class StaffChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = Course_Instructor
        fields = ('user_id', 'email', 'password','name','contact_no', 'desc', 'image' )
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('name','contact_no','desc','image',)}),
...
admin.site.register(Course_Instructor, UserAdmin)
